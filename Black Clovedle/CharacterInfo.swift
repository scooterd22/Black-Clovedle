...
struct CharacterInfo {
        let characters = [
                ...
                Character(name: "Jack The Ripper", gender: "Male", affiliation: "Green Preying Mantises", magicAttribute: "Blood Magic", spirit: "none", arcNumber: 7, debutArc: "Spade Kingdom Invasion", imageName: UIImage(named: "Jack The Ripper")),
